...
Scrypted Thin offers a smaller installation footprint by removing some dependencies - see [here](https://github.com/koush/scrypted/wiki/Docker-Image-Tags#images) to find out more.
...
Then select the Scrypted add-on and click Install. **This may take 5-10 minutes to complete as the image is approximately 1GB in size.**
